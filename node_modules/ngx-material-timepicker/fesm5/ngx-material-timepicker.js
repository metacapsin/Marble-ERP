...
var TimeAdapter = /** @class */ (function () {
    ...
    TimeAdapter.formatTime = function (time, opts) {
        ...
        if (format !== 24) {
            return parsedTime.toLocaleString(__assign({}, DateTime.TIME_SIMPLE, { hour12: format !== 24, numberingSystem: TimeAdapter.DEFAULT_NUMBERING_SYSTEM })).replace(/\u200E/g, '').replace(/\u202F/g, ' ');
        }
...
var TimeParserPipe = /** @class */ (function () {
    ...
    TimeParserPipe = __decorate([
        ...
        Injectable(),
        __param(0, Inject(TIME_LOCALE)), __param(1, Inject(NUMBERING_SYSTEM))
    ], TimeParserPipe);
