...
import { AddSlabBlockComponent } from "../add-slab-block/add-slab-block.component";
...
@Component({
  ...
  imports: [
    ...
    AddBlockComponent,
    AddSlabBlockComponent
],
  templateUrl: "./add-slab.component.html",
  styleUrl: "./add-slab.component.scss",
  providers: [MessageService],
})
export class AddSlabComponent implements OnInit, OnDestroy {
